...
def process_log_data(spark, input_data, output_data):
    ...
    print("----Write Time table in parquet format")
 ...
 \
    ...
    print("----Write Songplays table in parquet format")
    songplays_table.write.parquet(output_data + 'songplays/' + 'songplays.parquet',
                                  partitionBy=['start_time', 'user_id'])
...
def main():
    ...
    print("-- Load AWS Credentials")

    input_data = "s3a://udacity-fabio-haider/data/"
    output_data = "s3a://udacity-fabio-haider-sparkify-data-lake/"
    print("-- Set Input/Output Data")
